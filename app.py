...
# --- Streamlit UI ---
st.set_page_config(page_title="Snowflake Poster", page_icon="❄️", layout="wide")

st.title("❄️ Generative Snowflake Poster")
st.write("**Practice: Making Web-based Generative Poster**")
st.markdown("---")
